...
<head>
  ...
  <title>bpro Report — ${escHtml(config.project_name)} (${date})</title>
  <style>
...
<body>
  ...
  (function() {
    ...
    render();
      ...
      // Emit notification
      await emitEvent(bproDir, 'report.generated', `Report generated for ${config.project_name}`, {
